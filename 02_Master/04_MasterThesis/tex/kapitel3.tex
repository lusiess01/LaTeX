...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\textwidth]{img/ForecePlot.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\textwidth]{plots/SpringTest.eps}
...
\begin{figure}[ht]
    ...
    \end{subfigure}
    \vspace{0.1cm}
    \caption[Phase A]{(a) TimeHerzionClassicMode (b) TimeHerzionEnergyMode}
